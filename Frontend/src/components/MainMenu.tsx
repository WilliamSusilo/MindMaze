...
export default function MainMenu() {
  ...
  return (
    <div className="text-center text-white px-4 pt-12">
      ...
      <div className="mb-12">
        <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">MindMaze</h1>
      ...
      {showHowTo && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-slate-900 rounded-lg p-6 w-full max-w-4xl mx-4 overflow-y-auto max-h-[80vh]">
            <h3 className="text-2xl font-bold text-white mb-2">How to Play — MindMaze</h3>
